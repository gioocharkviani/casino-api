...
export class InitialSchema1780675586619 implements MigrationInterface {
    name = 'InitialSchema1780675586619'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`country\` ADD UNIQUE INDEX \`IDX_723b232a5bfd0fc0c36973e59f\` (\`countryCode\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`country\` DROP INDEX \`IDX_723b232a5bfd0fc0c36973e59f\``);
